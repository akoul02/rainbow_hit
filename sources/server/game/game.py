...
class Game:
    def start(self):
        ...
        # ]
        player_exec = Executor(Bot(0, 0, 'player', main_event), MAX_STEPS, run_user)
        enemy_exec  = Executor(Bot(0, 0, 'enemy',  main_event), MAX_STEPS, run_enemy)
        enemy_exec2 = Executor(Bot(0, 0, 'enemy2', main_event), MAX_STEPS, run_enemy2)
