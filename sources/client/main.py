...
class Client:
    def __init__(self):
        ...
        pilImage1 = Image.open("./assets/ufo1.png")
        ...
        pilImage2 = Image.open("./assets/ufo2.png")
    ...
    def creating_game_objects(self):
        ...
        self.cloud1 = Cloud(48, 80+32*1, self.canvas, "./assets/Cloud.png")
        self.cloud2 = Cloud(48+32*2, 80, self.canvas, "./assets/Cloud.png")
        self.cloud3 = Cloud(48+32*10, 80, self.canvas, "./assets/Cloud.png")
        self.cloud4 = Cloud(48, 80+32*4, self.canvas, "./assets/Cloud.png")
